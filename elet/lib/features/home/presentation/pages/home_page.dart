...
import 'package:let/features/chat/chat_page.dart';
...
import 'package:let/jobs/jobs_post_page.dart';
      ...
      bottomNavigationBar: isSidebarOpen
          ...
          : CurvedNavigationBar(
              ...
              items: const <Widget>[
                ...
                Icon(Icons.add_circle_outline_sharp, size: 25, color: Colors.white),
              ],
              onTap: (index) {
                setState(() {
